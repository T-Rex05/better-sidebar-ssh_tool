...
export const zh = {
  ...
  remote: 'SSH 远程',
  remoteTerminal: '远程终端',
  remoteAddServer: '添加服务器',
  remoteEditServer: '编辑服务器',
  remoteNoServers: '还没有配置服务器',
  remoteConnectFailed: '连接失败',
  remoteEmptyDir: '空目录',
  remoteStartSession: 'Start SSH Session in Directory',
  remoteDeleteDirDesc: '将递归删除远程目录「{path}」（不可恢复）。',
  remoteDeleteFileDesc: '将删除远程文件「{path}」（不可恢复）。',
  remoteFieldName: '名称',
  remoteFieldHost: '主机',
  remoteFieldPort: '端口',
  remoteFieldUsername: '用户名',
  remoteFieldRootPath: '根目录',
  remoteAuthType: '认证方式',
  remoteAuthPassword: '密码',
  remoteAuthKey: '私钥',
  remotePassword: '密码',
  remotePasswordKeep: '留空保持不变',
  remoteKeyPath: '私钥路径',
  remoteKeyPathPlaceholder: '留空自动使用 ~/.ssh 默认密钥（id_ed25519 等）',
  remotePassphrase: '口令',
  remoteTest: '测试连接',
  remoteTestOk: '连接成功，主目录：{home}',
  remoteTestFailed: '测试失败',
  remoteInvalidPort: '端口必须是 1-65535 的整数',
  remoteRequiredFields: '名称/主机/用户名必填',
  remoteDock: '分栏',
  remoteUndock: '回到对话视图',
  remoteUndockAll: '取消分栏',
  syncToRemote: '同步到服务器',
  remoteDownload: '从服务器下载',
  remoteBack: '返回服务器列表',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  remoteAddServer: 'Add server',
  remoteEditServer: 'Edit server',
  remoteNoServers: 'No servers configured yet',
  remoteConnectFailed: 'Connect failed',
  remoteEmptyDir: 'Empty directory',
  remoteStartSession: 'Start SSH Session in Directory',
  remoteDeleteDirDesc: 'This permanently deletes the remote directory "{path}" and everything inside it.',
  remoteDeleteFileDesc: 'This permanently deletes the remote file "{path}".',
  remoteFieldName: 'Name',
  remoteFieldHost: 'Host',
  remoteFieldPort: 'Port',
  remoteFieldUsername: 'Username',
  remoteFieldRootPath: 'Root path',
  remoteAuthType: 'Auth method',
  remoteAuthPassword: 'Password',
  remoteAuthKey: 'Private key',
  remotePassword: 'Password',
  remotePasswordKeep: 'Leave empty to keep unchanged',
  remoteKeyPath: 'Private key path',
  remoteKeyPathPlaceholder: 'Leave empty to use the ~/.ssh default key (id_ed25519 etc.)',
  remotePassphrase: 'Passphrase',
  remoteTest: 'Test connection',
  remoteTestOk: 'Connected, home: {home}',
  remoteTestFailed: 'Test failed',
  remoteInvalidPort: 'Port must be an integer between 1 and 65535',
  remoteRequiredFields: 'Name, host and username are required',
  remoteDock: 'Split',
  remoteUndock: 'Back to chat view',
  remoteUndockAll: 'Unsplit',
  syncToRemote: 'Sync to server',
  remoteDownload: 'Download from server',
